document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".f-navigation-list");
  const headerRef = document.querySelector(".f-header");
  const navigationRef = document.querySelector(".f-navigation");
